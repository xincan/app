layui.define(function(exports){
    ...
    var zTree = {
        ...
        "sync": function(option) {
            return jQuery.fn.zTree.init(jQuery(option.id), option.setting, option.data);
        }
        /**
         * 异步加载树
         * @param option
        ...
        ,"getZTree": function (id) {
            return jQuery.fn.zTree.getZTreeObj(id);
        }
        /**
         * 刷新选中节点父节点之下的数据
         * id  zTree树id
        ...
        ,"refresh": function (option) {
            var zTree = jQuery.fn.zTree.getZTreeObj(option.id);
            /*根据 zTree 的唯一标识 tId 快速获取节点 JSON 数据对象*/
            var parentNode = zTree.getNodeByTId(option.pId);
            /*选中指定节点*/
