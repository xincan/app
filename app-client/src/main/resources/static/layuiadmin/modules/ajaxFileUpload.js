layui.define(function(exports){
    ...
    jQuery.extend({
        ...
        ajaxFileUpload: function(s) {
            ...
            try{
                ...
                if (window.ActiveXObject) {
                    jQuery(form).attr('enctype', 'text/html');
                }else{
                    if(form.encoding){
    ...
    // fileupload
    var ajaxFileUpload = {
        "render": function(option, callback) {
            ...
            jQuery.ajaxFileUpload({
                ...
                type: option.type,
                secureuri : false,
                data : option.param,//需要传递的数据 json格式
                fileElementId : option.files,
    ...
    //输出test接口
    exports('ajaxFileUpload', ajaxFileUpload);
});